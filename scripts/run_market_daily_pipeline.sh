#!/usr/bin/env bash
# Daily market data pipeline for cloud cron.
# Runs the pre-report data chain serially:
# pool price -> broad non-pool price -> pool IV -> broad scan -> pool morning report.
