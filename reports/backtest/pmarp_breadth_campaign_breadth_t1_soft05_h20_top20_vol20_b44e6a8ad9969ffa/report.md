# Backtest Pipeline Report — pmarp_breadth_campaign_breadth_t1_soft05_h20_top20_vol20
...
## Key Gates
- is_sharpe_positive: `{'value': 0.4638, 'pass': True}`
- oos_sharpe_positive: `{'value': 1.2447, 'pass': True}`
- oos_ic_positive: `{'value': 0.02582046433121, 'pass': True}`
- oos_vs_is_sharpe_ratio_gte_0_5: `{'value': 2.6836998706338937, 'threshold': 0.5, 'pass': True}`
- annual_turnover_within_limit: `{'value': 6.2325, 'threshold': 20.0, 'pass': True}`

## Strategy Metrics
### IS
- is.cagr: `0.033042`
- is.annual_volatility: `0.07125`
- is.sharpe_ratio: `0.4638`
- is.max_drawdown: `-0.079311`
- is.annual_turnover: `2.2669`
- is.excess_cagr: `-0.007494000000000001`
- is.ir: `-0.11`
### OOS
- oos.cagr: `0.077259`
- oos.annual_volatility: `0.062072`
- oos.sharpe_ratio: `1.2447`
- oos.max_drawdown: `-0.061785`
- oos.annual_turnover: `6.2325`
- oos.excess_cagr: `-0.09684400000000001`
- oos.ir: `-0.5515`
...
```json
{
  ...
  "notes": "Breadth may support more breadth in holdings too; test top 20 names.",
  "period": {
    "start": "2021-07-01",
    "test_end": "2026-04-10",
  ...
  "spec_id": "pmarp_breadth_campaign_breadth_t1_soft05_h20_top20_vol20",
  "universe": {
    "exclude_sectors": [
      "Utilities",
      "Energy",
